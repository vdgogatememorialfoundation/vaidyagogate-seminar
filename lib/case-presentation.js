                        ...
                        db.get(
                            ...
                            async (e3, score) => {
                                ...
                                const participant = judgeContact.parseParticipantFromSubmission(sub, {
                                    ...
                                    user_id_string: sub.user_id_string
                                });
                                participant.userId = sub.user_id;
                                res.json({
                                    submission: sub,
                                    participant,
                                    files: enrichedFiles,
        ...
        resolveJudgeUserId(db, judgeUserId, judgeUserIdString, async (eJ, jid) => {
            ...
            db.get(
                ...
                (eA, assigned) => {
                    ...
                    if (!assigned) return res.status(403).json({ error: 'You are not assigned to this submission' });
                    db.get(
                        `SELECT u.id, u.first_name, u.last_name, u.email, u.phone, u.user_id_string
                        ...
                        (eJudge, judge) => {
                            ...
                            db.get(
                                ...
                                async (eSub, sub) => {
                                    ...
                                    participant.userId = sub.user_id;
                                    try {
                                        const result = await judgeContact.sendJudgeToParticipantEmail(db, {
                                            judge,
                                            participant,
                                            subject,
                                            message,
                                        ...
                                        res.json({
                                            ...
                                            fromDisplay: judgeContact.formatJudgeFromDisplay(judge)
                                        });
                                    } catch (sendErr) {
