...
Categories: Agnikarma · Viddhakarma
Prize: Cash prizes up to Rs.75,000/-
Eligibility: Practicing Vaidyas, P.G. Scholars, PhD scholars, Faculty members.

Submission details:
1. Submission should be in video format (max 50 MB per file).
2. This is your final submission — include all images, videos, documents in this upload only.
3. Present the case in IMRAD format.
4. Before and after case reports are welcome.
5. Viddhakarma / Agnikarma points must be precise; include reason for choosing each point.
6. Copied cases will be disqualified.
7. Do not submit the same case elsewhere; duplicate submission leads to disqualification.
8. Attach your CV with this signed undertaking: (a) judges' decision is final; (b) you will answer questions on the case; (c) all information provided is true.
9. Max presentation time: 10 + 2 minutes.
10. Judges may contact you for clarification or a live presentation.
11. Follow all medico-legal requirements; patient/parent consent must be available if requested.
12. Guru vandan is optional — your good case is itself Guru vandan.

Last date: 15 August 2026, 9:00 PM IST. Up to 20 good cases will be awarded.

Queries: Vd Poorva Gogate — 8275764426 / 9579368860
Support: care@vaidyagogate.org · vd.gogatememorialfoundation@gmail.com`;
...
const DEFAULT_CASE_FORM_CONFIG = {
    ...
    fields: [
        ...
        {
            key: 'files',
            label: 'Upload case video + signed CV (video max 50 MB; IMRAD presentation in video)',
            type: 'file',
            enabled: true,
            required: true
        }
