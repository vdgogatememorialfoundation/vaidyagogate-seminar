                        ...
                        db.run(
                            ...
                            (e3) => {
                                ...
                                db.run(`ALTER TABLE seminar_volunteers ADD COLUMN duties TEXT`, (e3d) => {
                                    ignoreErr(e3d);
                                db.run(`ALTER TABLE certificate_templates ADD COLUMN cert_type TEXT DEFAULT 'participant'`, (e4) => {
                                    ignoreErr(e4);
                                    db.run(`ALTER TABLE certificate_templates ADD COLUMN config_json TEXT`, (e4b) => {
                                        ignoreErr(e4b);
                                    db.run(
