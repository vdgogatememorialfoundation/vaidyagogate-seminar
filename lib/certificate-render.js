...
body.cert-print-body--capture .cert-inner{display:flex!important;min-height:calc(210mm - 40px)!important;padding:30px 60px;text-align:center;}
...
function renderCertificateHtml(ctx, opts) {
    ...
    const logoImg = ctx.logoUrl
        ? `<img class="cert-logo-center" src="${ctx.logoUrl}" alt="VGMF">`
        : '<div class="cert-logo-fallback" aria-hidden="true">VGMF</div>';
...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;700&family=Playfair+Display:wght@400;600;700&family=Pinyon+Script&display=swap" rel="stylesheet">
${cssBlock}
