...
body.cert-print-body--capture{margin:0;padding:0;background:#fff;width:1123px;overflow:hidden;}
body.cert-print-body--capture .cert-page{width:1123px!important;max-width:none!important;min-height:794px!important;height:794px!important;margin:0;box-shadow:none;}
body.cert-print-body--capture .cert-inner{min-height:770px;justify-content:flex-start;padding-top:36px;}
body.cert-print-body--capture .cert-title{font-size:2.65rem;letter-spacing:0.22em;}
body.cert-print-body--capture .cert-name{font-size:2.5rem;}
`;
