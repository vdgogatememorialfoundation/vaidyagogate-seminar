...
async function ensureAuxiliaryTables(queryWithRetry, isIgnorablePgError) {
    ...
    for (const sql of [
        ...
        "ALTER TABLE seminars ADD COLUMN IF NOT EXISTS delivery_mode TEXT DEFAULT 'in_person'",
        'ALTER TABLE seminars ADD COLUMN IF NOT EXISTS webinar_provider TEXT',
        'ALTER TABLE seminars ADD COLUMN IF NOT EXISTS webinar_meeting_url TEXT',
        'ALTER TABLE seminars ADD COLUMN IF NOT EXISTS webinar_join_instructions TEXT',
        'ALTER TABLE seminars ADD COLUMN IF NOT EXISTS webinar_join_opens TIMESTAMPTZ',
        'ALTER TABLE seminars ADD COLUMN IF NOT EXISTS webinar_join_closes TIMESTAMPTZ',
        'ALTER TABLE seminars ADD COLUMN IF NOT EXISTS webinar_single_device INTEGER DEFAULT 0',
