...
const AUX_TABLE_DDL = [
    ...
    {
        name: 'venue_entry_profiles',
        sql: `CREATE TABLE IF NOT EXISTS venue_entry_profiles (
    ...
    {
        name: 'venue_entry_passes',
        sql: `CREATE TABLE IF NOT EXISTS venue_entry_passes (
            id SERIAL PRIMARY KEY,
            user_id INTEGER NOT NULL,
    ...
    {
        name: 'venue_entry_events',
        sql: `CREATE TABLE IF NOT EXISTS venue_entry_events (
            id SERIAL PRIMARY KEY,
            pass_id INTEGER,
            seminar_id INTEGER NOT NULL,
            registration_id INTEGER,
