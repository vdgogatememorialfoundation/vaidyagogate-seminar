...
const PORTAL_PATHS = {
    doctor_support: PATHS.doctor + '#tab-support',
    doctor_case: PATHS.doctor + '#tab-case',
    judge: PATHS.judge,
    admin_support: PATHS.admin + '#tab-support-tickets',
    support_desk: PATHS.support,
    admin_mail_threads: PATHS.admin + '#tab-email-compose',
    admin_contact_inquiries: PATHS.admin + '#tab-contact-inquiries'
};
