...
const EXPECTED_MOBILE_URLS = {
    admin: 'https://seminar.vaidyagogate.org/admin',
    judge: 'https://seminar.vaidyagogate.org/judge',
    doctor: 'https://seminar.vaidyagogate.org/doctor',
    scanner: 'https://seminar.vaidyagogate.org/scanner'
};
    ...
    db.get('SELECT 1 AS ok', [], (dbErr) => {
        push(
            statusRow(
                ...
                dbErr ? 'Check DATABASE_URL / Postgres on Render.' : ''
            )
        );
