    ...
    },
    {
        ...
        email_html: wrapHtml(
            ...
            '<p>Dear {{full_name}},</p><p>Your account has been successfully created for the ' +
                SEMINAR +
                ' portal.</p><p><strong>Your Login Details:</strong><br>User ID: {{user_id_string}}<br>Registered Email: {{email}}</p>' +
        ...
        whatsapp_body:
            ...
            SEMINAR +
            '.\n🆔 User ID: {{user_id_string}}\n📧 Email: {{email}}\nYou can now log in and continue your registration.'
    },
    {
    ...
    },
    {
        ...
        email_html: wrapHtml(
            ...
            '<p>Dear {{full_name}},</p><p>Your e-ticket for the ' +
                ...
                '<p>Please carry your e-ticket during event entry.</p><p><a href="{{qr_code_url}}">View QR ticket</a></p>'
        ),
        whatsapp_body:
    ...
    },
    {
        ...
        email_html: wrapHtml(
            ...
            '<p>Dear {{full_name}},</p><p>Congratulations! Your E-Certificate for participating in the ' +
                ...
                '<p>You can now log in to the portal and download your certificate.</p><p><a href="{{certificate_url}}">Download certificate</a></p>'
        ),
        whatsapp_body:
...
module.exports = { EVENT_KEYS, DEFAULT_TEMPLATES, wrapHtml, SEMINAR };
