...
const DEFAULT_TEMPLATES = [
    ...
    },
    {
        ...
        email_html: wrapHtml(
            ...
            '<p>Dear {{full_name}},</p><p>We received your support ticket <strong>{{ticket_id}}</strong> regarding <strong>{{ticket_subject}}</strong>.</p><p>Our team will reply in the doctor portal. You can follow the conversation here:</p>' +
