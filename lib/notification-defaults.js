...
const DEFAULT_TEMPLATES = [
    ...
    },
    {
        ...
        email_html: wrapHtml(
            'Judging complete',
            '<p>Dear {{full_name}},</p><p>All assigned judges have submitted scores for your case <strong>CASE-{{application_no}}</strong> ({{case_presentation_title}}).</p>' +
    ...
    },
    {
        ...
        email_html: wrapHtml(
            ...
            '<p>Dear {{full_name}},</p><p>Congratulations! Your case presentation <strong>CASE-{{application_no}}</strong> ({{case_presentation_title}}) has been <strong>selected</strong>.</p>' +
                '<p>Further instructions will follow by email or in the doctor portal.</p>' +
                emailCtaButton('{{portal_login_url}}', 'Open doctor portal')
        ),
        whatsapp_body:
            '🎉 Congratulations {{first_name}}!\nCase CASE-{{application_no}} selected.\nDetails: {{portal_login_url}}'
    },
    {
