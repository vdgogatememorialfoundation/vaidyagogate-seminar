...
const DEFAULT_TEMPLATES = [
    ...
    },
    {
        ...
        whatsapp_body:
            '🎟️ E-Tickets Generated\nHello {{first_name}},\nYour registration for National Seminar 2026 is confirmed.\n\n{{ticket_summary}}\n\nPlease keep this message for entry. Your QR tickets are available in your participant dashboard.'
    },
    {
        ...
        email_html: wrapHtml(
            ...
            '<p>Dear {{full_name}},</p><p>Congratulations! Your application for the ' +
                ...
                '<p>Complete payment to confirm your seat. We look forward to welcoming you.</p>' +
                emailCtaButton('{{payment_link}}', 'Pay seminar fee now') +
                '<p style="font-size:0.9rem;color:#64748b;margin-top:16px;">The button opens the <strong>Payments</strong> tab of the doctor portal (sign in if prompted).</p>' +
                emailCtaButton('{{portal_login_url}}', 'Open doctor portal'),
            { subtitle: 'Your seminar application is approved.' }
        ),
        whatsapp_body:
            '🎉 Application Approved!\nHello {{first_name}},\nYour application for National Seminar 2026 has been approved successfully.\n📄 Application ID: {{application_no}}\n📌 Status: Approved\n💳 Pay here to confirm your seat: {{payment_link}}'
    },
    {
