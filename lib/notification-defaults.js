    ...
    },
    {
        ...
        email_html: wrapHtml(
            ...
            '<p>Dear {{full_name}},</p>' +
                ...
                '<p style="margin:0 0 8px;"><strong>Seminar:</strong> {{seminar_name}}</p>' +
                '<p style="margin:0 0 8px;"><strong>Application no.:</strong> {{application_no}}</p>' +
                '<p style="margin:0 0 8px;"><strong>Status:</strong> Cancelled</p>' +
                '<p style="margin:0;"><strong>Your reason:</strong> {{cancellation_reason}}</p>' +
                '</div>' +
                '<p><strong>Office note:</strong> {{admin_notes}}</p>' +
                '<p>If a refund applies, you will receive a separate update. Amount eligible: ₹{{refund_amount}} ({{refund_percent}}% of fee paid).</p>' +
                '<p>Questions? Contact {{admin_contact}}.</p>' +
                emailCtaButton('{{portal_login_url}}', 'View doctor portal')
        ),
        whatsapp_body:
            'Hello {{first_name}}, your registration {{application_no}} for {{seminar_name}} is cancelled. Office note: {{admin_notes}}. Refund if applicable: Rs {{refund_amount}}. Portal: {{portal_login_url}}'
    },
    {
        ...
        email_html: wrapHtml(
            'Refund initiated',
            '<p>Dear {{full_name}},</p>' +
                '<p>A refund of <strong>₹{{refund_amount}}</strong> has been initiated for your cancelled seminar registration.</p>' +
                ...
                '</div>' +
                '<p>It may take 5–10 business days to reflect in your bank or card statement depending on your payment provider.</p>' +
                '<p>Contact {{admin_contact}} if you do not see the credit after this period.</p>' +
                emailCtaButton('{{portal_login_url}}', 'Track in doctor portal')
        ),
        whatsapp_body:
            'Refund of Rs {{refund_amount}} initiated for application {{application_no}} ({{seminar_name}}). Allow 5-10 business days. Contact {{admin_contact}} if needed.'
    },
    {
        ...
        email_html: wrapHtml(
            'Refund completed',
            '<p>Dear {{full_name}},</p>' +
                '<p>Your refund of <strong>₹{{refund_amount}}</strong> for seminar registration <strong>{{application_no}}</strong> has been <strong>processed successfully</strong>.</p>' +
                '<p>Please check your bank or card statement. If anything looks incorrect, contact {{admin_contact}}.</p>' +
                emailCtaButton('{{portal_login_url}}', 'Open doctor portal')
        ),
        whatsapp_body:
            'Refund of Rs {{refund_amount}} completed for {{application_no}} ({{seminar_name}}). Check your bank statement. Support: {{admin_contact}}.'
    },
    {
