        ...
        (err, sem) => {
            ...
            db.all(
                ...
                (e2, days) => {
                    ...
                    const effective = override || localDateYmd();
                    ...
                    const active = list.find((d) => d.checkinDate === effective) || null;
                    cb(null, {
                        seminarCheckinEnabled: !!(sem && (sem.checkin_enabled === true || Number(sem.checkin_enabled) === 1)),
                        overrideDate: override || null,
    ...
    app.get('/api/admin/live-scanner/roster', (req, res) => {
        ...
        db.all(
            ...
            (err, rows) => {
                ...
                const roster = Array.from(byReg.values());
