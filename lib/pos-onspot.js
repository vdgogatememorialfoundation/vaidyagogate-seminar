        ...
        seminarCapacity.assertSeminarHasCapacity(db, sid, (capErr, capBlock) => {
            ...
            findUser((_, existingUserId) => {
                const createUser = (cb) => {
                    ...
                    bcrypt.hash(tempPass, 10, (hashErr, hash) => {
                        ...
                        db.run(
                            ...
                            [uidStr, fn, ln, loginEmail, ph || '', hash],
                            function (insErr) {
                                if (insErr) {
                        ...
                        (rErr, existingReg) => {
                                    ...
                                    fulfillRegistrationPayment(
                                        ...
                                        (fErr, meta) => {
                                            ...
                                            activityLog.logActivity(db, {
                                                ...
                                                meta: { seminarId: sid, userId, ticketId: meta && meta.ticketId }
                                            });
                                            res.json({
                                                success: true,
                                                userId,
                            ...
                            db.run(
                                ...
                                [
                                    ...
                                    sid,
                                    appNo,
                                    JSON.stringify({ source: 'pos', onSpot: true, registeredBy: actor.id })
                                ],
                                function (insRegErr) {
