...
function registerVenueEntryRoutes(app, deps) {
    ...
    const syncCertificateEligibilityForTicket = deps.syncCertificateEligibilityForTicket;
                        ...
                        (uErr) => {
                            ...
                            db.run(
                                ...
                                () => {
                                    ...
                                    if (typeof syncCertificateEligibilityForTicket === 'function') {
                                        syncCertificateEligibilityForTicket(row.ticket_db_id, done);
                                    } else {
                                        done();
                                    }
                                }
