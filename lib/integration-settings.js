...
function getEmailApiFallbackProvider() {
    const rt = getRuntimeIntegrations();
    if (!flagEnabled(rt.email_fallback_enabled, true)) return '';
    const p = String(
...
function getEmailConfigStatus() {
    ...
    const fallbackEnabled = flagEnabled(rt.email_fallback_enabled, true);
    const smtpStandbyEnabled = flagEnabled(rt.email_smtp_standby_enabled, true);
