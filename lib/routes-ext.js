                            ...
                            db.run(
                                ...
                                () => {
                                    portalTracking.logCaseEvent(
                                        ...
                                        'Judges assigned',
                                        unique.length +
                                            ' judge(s) assigned. Marking deadline: ' +
                                            caseMarkingDeadline.formatMarkingDeadlineDisplay(markingDeadlineNorm),
                                        () => {
                                            const caseNotify = require('./case-presentation-notify');
                                            caseNotify.notifyCaseDoctor(
                                                db,
                                                ...
                                                () => {
                                                    caseJudgeReminders.notifyAssignedJudges(db, sid, unique, () => {
                                                        res.json({
                                                            success: true,
                                                            judgeIds: unique,
