                                                            ...
                                                            (e3, rrow) => {
                                                                ...
                                                                db.run(
                                                                    `INSERT INTO volunteer_certificates (user_id, seminar_id, registration_id, display_name, enabled, scan_verified)
                                                                     VALUES (?, ?, ?, ?, 0, 0)
                                                                     ON CONFLICT(user_id, seminar_id) DO UPDATE SET display_name = excluded.display_name, scan_verified = excluded.scan_verified`,
                                                                        ...
                                                                        db.get(
                                                                            ...
                                                                            (eTid, trow) => {
                                                                                ...
                                                                                res.json({
                                                                                    ...
                                                                                    ticketId: ticketStr,
                                                                                    message:
                                                                                        'Volunteer approved. Free registration and e-ticket created. After venue QR scan, participant certificate becomes eligible; enable volunteer certificate in admin when ready.'
                                                                                });
                                                                            }
                                                                        );
                                                                    }
