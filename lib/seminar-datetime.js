...
function parseSeminarDateTime(val) {
    ...
    // Naive values without offset: legacy rows used UTC digits from toISOString().slice(0, 19).
    // Current storage always includes +05:30 (see normalizeSeminarDateTimeForStorage).
