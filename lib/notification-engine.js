...
const { formatSeminarDateTime, formatSeminarDateForTicketLine, formatSeminarSchedule } = require('./seminar-datetime');
const {
...
function sendTicketIssuedEmail(db, opts, cb) {
            ...
            .buildTicketHtmlFromRow(
                {
                    ...
                    event_end_date: r.day_date || r.sub_event_date ? null : r.event_end_date,
    ...
    const buildAttachments = () => {
        ...
        return Promise.all(ticketRows.map(buildOneAttachment))
            ...
            fetchContext(db, { userId, seminarId, registrationId }, (ce, ctx) => {
                ...
                const vars = buildVarsFromRows(
                    ...
                    Object.assign(
                        {
                            ticket_id: ticketId,
                            ticket_ids: ticketRows.map((tr) => tr.ticket_id_string).join(', ') || String(ticketId),
                            ticket_count: ticketRows.length || 1,
