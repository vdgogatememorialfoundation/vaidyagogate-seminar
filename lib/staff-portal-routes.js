...
const appReviewerSchema = require('./application-reviewer-schema');

function registerStaffPortalRoutes(app, db, deps) {
    const guard = (section, fn) => bookAuth.requireBookSalesActor(db, { section }, fn);
    const withAppReviewSchema = (handler) => (req, res) => {
        appReviewerSchema.ensureApplicationReviewerSchema(db, () => {}, () => handler(req, res));
    };
    ...
    app.get('/api/staff/applications', guard('applications', withAppReviewSchema((req, res) => {
    ...
    app.get('/api/staff/applications/:applicationId', guard('applications', withAppReviewSchema((req, res) => {
    ...
    app.post('/api/staff/applications/:applicationId/escalate', guard('applications', withAppReviewSchema((req, res) => {
    ...
    app.post('/api/staff/applications/:applicationId/document-verify', guard('applications', withAppReviewSchema((req, res) => {
    ...
    app.post('/api/staff/applications/status', guard('applications', withAppReviewSchema((req, res) => {
