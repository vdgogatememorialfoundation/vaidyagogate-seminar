...
async function refundRazorpay({ keyId, keySecret, paymentId, amountRupees }) {
    ...
    return new Promise((resolve) => {
        rzCall((next) => rz.payments.refund(paymentId, { amount: paisa, speed: 'normal' }, next), (err, refund) => {
            ...
            resolve({
                ...
                providerStatus: refund && refund.status,
                paymentId: refund && refund.payment_id,
                raw: refund
            });
        });
    });
